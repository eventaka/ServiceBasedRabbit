    ...
    public class RestServiceController : ControllerBase
    {
        ...
        public async Task<IActionResult> CreateUserAsync([FromBody] UserDto userdto)
        {
            ...
            try
            {
                ...
                _publisherMessage.Publish(userdto); //,"report.order",null); // routing..
        ...
        public async Task<IActionResult> CreateItemAsync([FromBody] ItemDto itemdto)
        {
            ...
            try
            {
                ...
                _publisherMessage.Publish(itemdto); //,"report.order",null); // routing..
        ...
        public async Task<IActionResult> PostUserItemAsync([FromBody] UserItemDto userItemDto)
        {
            ...
            {
                // Validation
                 _publisherMessage.Publish(userItemDto); //,"report.order",null); // routing..
        ...
        public async Task<IActionResult> DeleteUserItemAsync(int id)
        {
            ...
            try
            {
                ...
                // Validation
                _publisherMessage.Publish(id); //,"report.order",null); // routing..
